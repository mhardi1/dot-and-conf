...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, altkey    }, "Return", function () awful.spawn(terminalalt) end,
              {description = "open a terminalalt", group = "launcher"}),
